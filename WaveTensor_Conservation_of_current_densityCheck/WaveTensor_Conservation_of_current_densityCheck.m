...
[ Reflectance, Reflectance_phase ] = reflectance( number_of_points,Rp_abs,Rp_phase,Rs_abs,Rs_phase);
[ Tp_abs,Tp_phase ]=Tp_abs_phase ( number_of_points,Mp,theta_0);
[ Ts_abs,Ts_phase ]=Ts_abs_phase ( number_of_points,Ms,theta_0);
[Transmittance,Transmittance_phase]=transmittance (number_of_points,Tp_abs,Tp_phase,Ts_abs,Ts_phase);

theta_0_degree=theta_0(1)*180/pi;

Writting_Results(tag,number_of_layers,number_of_points,V,theta_0_degree,lambda_0,Mp,Ms,Rp_abs,Rp_phase,Rs_abs,Rs_phase,Reflectance,Reflectance_phase,Transmittance,Transmittance_phase,rp,tp,rs,ts,q,con);
Plotting_Rp_Rs_abs_phase(tag,lambda_0,number_of_layers,V,theta_0_degree,Rp_abs,Rp_phase,Rs_abs,Rs_phase,Reflectance, Reflectance_phase,Tp_abs,Tp_phase,Ts_abs,Ts_phase,Transmittance,Transmittance_phase);
